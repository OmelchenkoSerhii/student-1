...
function theme_setup(){
	load_theme_textdomain( 'rocket-saas', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array( 
			'main-menu' => __( 'Main Menu', 'rocket-saas' ),
			'footer-menu-1' => __( 'Footer Menu 1', 'rocket-saas'),
			'footer-menu-2' => __( 'Footer Menu 2', 'rocket-saas'),
            'footer-bottom-menu' => __( 'Footer Bottom Menu', 'rocket-saas'),  
		)
    );
